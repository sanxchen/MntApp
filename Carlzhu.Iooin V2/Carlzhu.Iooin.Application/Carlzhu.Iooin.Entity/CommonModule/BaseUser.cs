...
using CommonHelper = Carlzhu.Iooin.Util.CommonHelper;
using DESEncrypt = Carlzhu.Iooin.Util.DESEncrypt;
using Md5Helper = Carlzhu.Iooin.Util.Md5Helper;
...
namespace Carlzhu.Iooin.Entity.CommonModule
{
    ...
    public class BaseUser : BaseEntity
    {
        ...
        {
            this.UserId = this.Code;//CommonHelper.GetGuid;
