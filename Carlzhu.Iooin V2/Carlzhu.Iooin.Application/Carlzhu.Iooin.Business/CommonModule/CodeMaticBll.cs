...
namespace Carlzhu.Iooin.Business.CommonModule
{
    ...
    public class CodeMaticBll
    {
        ...
        public XmlNodeList GetTableName()
        {
            ...
            myXmlDocument.Load(DirFileHelper.MapPath("~/Areas/CodeMaticModule/DataModel/Carlzhu.Iooin.Framework.pdm"));
            // 获取表格
        ...
        public string CodeBuilder_Entity(string table, string Key, DataTable Entity_dt)
        {
            ...
            sb_Entity.Append("\r\n\r\n");
            sb_Entity.Append("using Carlzhu.Iooin.DataAccess.Attributes;\r\n");
            sb_Entity.Append("\r\n");
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'CreateDate'");
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'CreateUserId'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'CreateUserName'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'ModifyDate'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'ModifyUserId'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "column_name = 'ModifyUserName'");
            if (newdt.Rows.Count > 0)
            {
        ...
        public string GetCodeBuilderBusiness(string table)
        {
            ...
            sb_Business.Append("\r\n\r\n");
            sb_Business.Append("using Carlzhu.Iooin.Entity;\r\n");
            sb_Business.Append("\r\n");
            sb_Business.Append("\r\n");
        ...
        public string GetCodeBuilderController(string table)
        {
            ...
            sb_Controller.Append("using Carlzhu.Iooin.Business;\r\n");
            sb_Controller.Append("using Carlzhu.Iooin.Entity;\r\n");
            ...
            sb_Controller.Append("namespace Carlzhu.Iooin.WebApp.Areas." + AreasName + ".Controllers\r\n");
            sb_Controller.Append("{\r\n");
